...
interface ActiveFiltersProps {
  ...
  onClearFilter: (filterType: 'district' | 'cuisine' | 'priceRange' | 'tags' | 'showOpenOnly', value?: string) => void;
  onClearAll: () => void;
}
    ...
    <div className="mb-6 p-4 border rounded-lg animate-fade-in">
      ...
      <div className="flex flex-wrap gap-2">
        {activeFilters.map(filter => (
          <Badge key={filter.type} variant="secondary" className="pl-3 pr-1 py-1 text-sm font-normal">
